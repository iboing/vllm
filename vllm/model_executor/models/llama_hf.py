...
class LlamaAttention(nn.Module):
    ...
    def __init__(
        ...
        self.k_proj = nn.Linear(self.hidden_size, self.total_num_kv_heads * self.head_dim, bias=bias)
        self.v_proj = nn.Linear(self.hidden_size, self.total_num_kv_heads * self.head_dim, bias=bias)
